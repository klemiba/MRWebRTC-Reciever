...
Shader "Mixed Reality Toolkit/Standard"
{
    Properties
    {
        ...
        [Toggle(_BORDER_LIGHT_CHANGE)] _BorderLightChange("Border Light Change", Float) = 0.0
    ...
    SubShader
    {
        Pass
        {
            ...
            #pragma shader_feature _BORDER_LIGHT_CHANGE
...
#else
#if defined(_BORDER_LIGHT_CHANGE)
                // Changed borderlight : TODO: Scale better
                fixed3 borderColor = fixed3(21, 6.5, 4.2);
#else
