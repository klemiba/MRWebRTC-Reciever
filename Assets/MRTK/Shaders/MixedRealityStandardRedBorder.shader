...
Shader "Mixed Reality Toolkit/StandardRedBorder"
{
    Properties
    {
        // Main maps.
...
#else
                fixed3 borderColor = fixed3(1.0, 0.0, 0.0);
#endif
                fixed3 borderContribution = borderColor * borderValue * _BorderMinValue * _FluentLightIntensity * 3;
